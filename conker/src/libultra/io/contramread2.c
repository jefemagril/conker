...
void __osPackRamReadData2(int channel, u16 address);

s32 __osContRamRead2(OSMesgQueue *mq, int channel, u16 address, u8 *buffer)
{
    s32 ret = 0;
    int i;
    ...
    __osPackRamReadData2(channel, address);
